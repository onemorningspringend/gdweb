gsp.module("gsp.app").controller("GDWebReduceCardController", "CardController",
    ['BizHandlePub', function (Pub) {
            ...
            */
            ChangeState: function (OperationFlag) {
                ...
                switch (OperationFlag) {
                    case "2": cardself.context.view().transitInvoke('Create', [{
                        target: 'GDWebReduceCardController',
                        methodName: 'ReduceCardCreate',
                        params: []
                    }]);
                        break;
                    case "3": cardself.context.view().transitInvoke('Modify', [{
                        target: 'GDWebReduceCardController',
                        methodName: 'ReduceCardEdit',
                        params: []
                    }]);
                        break;
                    case "4": cardself.context.view().transitInvoke('Modify', [{
                        target: 'GDWebReduceCardController',
                        methodName: 'ReduceCardEdit',
                        params: []
                    }]);
