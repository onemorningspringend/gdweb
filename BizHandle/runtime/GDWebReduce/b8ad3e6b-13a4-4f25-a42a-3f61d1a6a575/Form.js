...
CreateDateTime :[2018/9/17 9:09:28]
...
GSP Mobile RunTime Models Script
Auto Created by GSP_ADP_Form_UIEnginer
CreateDateTime :[2018/9/17 9:09:32]
If you have any questions, Please contact ADP development team or Mail: zhushy@inspur.com !
*/
...
CreateDateTime :[2018/9/17 9:09:31]
If you have any questions, Please contact ADP development team or Mail: zhushy@inspur.com !
*/
...
,
			...
			this.setActionCollection({
				...
				BindExitFunc: {transit:'', params:[], methodInfo:{target:'GDWebReduceListController', methodName:'BindExitFunc'} }
			});
...
$('#presetBar').buttongroup();
			...
			this.stateMachine.init();
			this.extendAction('Formload', 'afterActionExtend', {target:'GDWebReduceListController', methodName: 'BindExitFunc'});
		},
