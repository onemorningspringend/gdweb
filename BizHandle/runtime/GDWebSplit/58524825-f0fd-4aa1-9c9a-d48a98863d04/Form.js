...
CreateDateTime :[2017/12/19 16:14:17]
...
,
			...
			this.setActionCollection({
				...
				btnDivideByAmount: {transit:'', params:[], methodInfo:{target:'GDWebSplitListXXController', methodName:'btnDivideByAmount'} },
				btnDivideByMoney: {transit:'', params:[], methodInfo:{target:'GDWebSplitListXXController', methodName:'btnDivideByMoney'} },
				btnSave: {transit:'', params:[], methodInfo:{target:'GDWebSplitListXXController', methodName:'btnSave'} }
			});

			$('#bfabc0fd-33a2-42c7-892f-340c5a8a10df').on('click', this.eventAgent(['btnDivideByAmount'], this, true));
						$(document).bind('keydown','Ctrl+Q',function(){ 

									$('#bfabc0fd-33a2-42c7-892f-340c5a8a10df').focus().click();
									return false;
									});
			$('#75a668a7-d847-4b18-a762-26acb59afc44').on('click', this.eventAgent(['btnDivideByMoney'], this, true));
						$(document).bind('keydown','Ctrl+J',function(){ 

									$('#75a668a7-d847-4b18-a762-26acb59afc44').focus().click();
									return false;
									});
			$('#72cb065a-2bbc-4379-875e-9318fa5e311c').on('click', this.eventAgent(['btnSave'], this, true));
						$(document).bind('keydown','Ctrl+S',function(){ 

									$('#72cb065a-2bbc-4379-875e-9318fa5e311c').focus().click();
									return false;
									});
			$('#4956d57e-0954-491e-a7da-bb02870e8b9e').on('click', this.eventAgent(['close'], this, true));
						$(document).bind('keydown','Ctrl+X',function(){ 

									$('#4956d57e-0954-491e-a7da-bb02870e8b9e').focus().click();
									return false;
									});
...
$('#presetBar').buttongroup();
			...
			this.stateMachine.init();
				...
				onInitialized: function () {
						...
						this.context.setParam('formID', '58524825-f0fd-4aa1-9c9a-d48a98863d04');
						var self = this,
...
$('#XSmartDictLookup_Zcbh').adplookupbox({ 
	adp:{
