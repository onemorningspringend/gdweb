...
CreateDateTime :[2017/12/19 16:13:50]
...
CreateDateTime :[2017/12/19 16:13:52]
If you have any questions, Please contact ADP development team or Mail: zhushy@inspur.com !
*/
...
,
			...
			this.setActionCollection({
				...
				Formload: {transit:'', params:[], methodInfo:{target:'GDWebSplitListController', methodName:'Formload'} },
				btnAdd: {transit:'', params:[], methodInfo:{target:'GDWebSplitListController', methodName:'btnAdd'} },
				btnView: {transit:'', params:[], methodInfo:{target:'GDWebSplitListController', methodName:'btnView'} },
				btnDelete: {transit:'', params:[], methodInfo:{target:'GDWebSplitListController', methodName:'btnDelete'} }
			});

			$('#64f3a016-182a-493d-bc75-09678edb48d3').on('click', this.eventAgent(['btnAdd'], this, true));
						$(document).bind('keydown','Ctrl+N',function(){ 

									$('#64f3a016-182a-493d-bc75-09678edb48d3').focus().click();
									return false;
									});
			$('#3ef1fecb-d833-4e91-8334-1046506eb8e5').on('click', this.eventAgent(['btnView'], this, true));
						$(document).bind('keydown','Ctrl+V',function(){ 

									$('#3ef1fecb-d833-4e91-8334-1046506eb8e5').focus().click();
									return false;
									});
			$('#481d9f1d-d584-40f6-8de6-f7659b731cd7').on('click', this.eventAgent(['btnDelete'], this, true));
						$(document).bind('keydown','Ctrl+D',function(){ 

									$('#481d9f1d-d584-40f6-8de6-f7659b731cd7').focus().click();
									return false;
									});
			$('#e56ba064-e41d-4c82-9889-ed674deeec19').on('click', this.eventAgent(['close'], this, true));
						$(document).bind('keydown','Ctrl+X',function(){ 

									$('#e56ba064-e41d-4c82-9889-ed674deeec19').focus().click();
									return false;
									});
			$('#XDataGridZCCF').on('onSelectDataChanged', this.eventAgent(['onSelectedChanged'], this, true));
$('#presetBar').buttongroup();
			...
			this.stateMachine.init();
				...
				onInitialized: function () {
						...
						this.context.setParam('formID', '0402323c-d0a4-44e6-a713-1602d444931d');
						var self = this,
...
if(invokeResult && invokeResult['then']){
    invokeResult.then(function(){
        return self.transitInvoke([ {target: 'ListBaseController', methodName: 'serverFilter', params: []}, {target: 'GDWebSplitListController', methodName: 'Formload', params: []}]);
    });
}
else{
    self.transitInvoke([ {target: 'ListBaseController', methodName: 'serverFilter', params: []}, {target: 'GDWebSplitListController', methodName: 'Formload', params: []}]);
}
