...
CreateDateTime :[2017/12/8 17:15:20]
...
GSP Mobile RunTime Models Script
Auto Created by GSP_ADP_Form_UIEnginer
CreateDateTime :[2017/12/8 17:15:21]
If you have any questions, Please contact ADP development team or Mail: zhushy@inspur.com !
*/
...
appModule.model('Instance_DM_GD_GDJSZC','GSPModelExtend', ['$dataServiceProxy', function($dataServiceProxy){
		return {
				...
				defaultInstance:'DM_GD_GDJSZC_ListInstance',
				primaryKey: 'GDJSZC_ID',
				dataUri: 'FormDataAccess.Web',
				isUseAccessoryMgr:0,
				enableFetchOptimization: false,
				...
				instances: {
						'DM_GD_GDJSZC_ListInstance': {
								view: '3',
								dataSourceName:'DM_GD_GDJSZC_ListInstance',
								defaultLoad: true,
								filter: '',
								sort: '',
								pagination: {pageSize:20}
...
appModule.view('IFrameRecover',['$stateMachine', '$context', function($stateMachine, appContext){
		return {
				render: function () {
				},

				initWidgets: function () {
						$.parser.parse($('#IFrameRecover'));
				},
...
*/
						 ...
						 var Dict_XSelector1GDJSZC_CWQR = [{label: '否', value: '0'},{label: '是', value: '1'}];
...
,
			...
			this.setActionCollection({
				...
				BizHandlePub: {transit:'', params:[], methodInfo:{target:'GDWebBizHandlePub', methodName:'BizHandlePub'} },
				ViewCard: {transit:'', params:[], methodInfo:{target:'GDWebReduceListController', methodName:'ViewCard'} },
				CreateCard: {transit:'', params:[], methodInfo:{target:'GDWebReduceListController', methodName:'CreateCard'} },
				Editcard: {transit:'', params:[], methodInfo:{target:'GDWebReduceListController', methodName:'Editcard'} },
				Formload: {transit:'', params:[], methodInfo:{target:'GDWebReduceListController', methodName:'Formload'} },
				DelReduce: {transit:'', params:[], methodInfo:{target:'GDWebReduceListController', methodName:'DelReduce'} },
				FICancelConfig: {transit:'', params:[], methodInfo:{target:'GDWebReduceListController', methodName:'FICancelConfig'} },
				FIConfig: {transit:'', params:[], methodInfo:{target:'GDWebReduceListController', methodName:'FIConfig'} },
				BatchConfig: {transit:'', params:[], methodInfo:{target:'GDWebReduceListController', methodName:'BatchConfig'} },
				Resume: {transit:'', params:[], methodInfo:{target:'GDWebReduceListController', methodName:'Resume'} }
			});

			$('#19bcb247-b27a-48ee-a081-f5c7af9f6f06').on('click', this.eventAgent(['ViewCard'], this, true));
						$(document).bind('keydown','Alt+Ctrl+V',function(){ 

									$('#19bcb247-b27a-48ee-a081-f5c7af9f6f06').focus().click();
									return false;
									});
			$('#c492e283-14b7-4410-af99-6ad55f6eeca6').on('click', this.eventAgent(['CreateCard'], this, true));
						$(document).bind('keydown','Alt+Ctrl+A',function(){ 

									$('#c492e283-14b7-4410-af99-6ad55f6eeca6').focus().click();
									return false;
									});
			$('#d2a8a8ff-52c9-47fa-8fcf-c37126c2edec').on('click', this.eventAgent(['Editcard'], this, true));
						$(document).bind('keydown','Alt+Ctrl+E',function(){ 

									$('#d2a8a8ff-52c9-47fa-8fcf-c37126c2edec').focus().click();
									return false;
									});
			$('#014e0807-2843-4b79-9298-4894be88b6f3').on('click', this.eventAgent(['DelReduce'], this, true));
						$(document).bind('keydown','Alt+Ctrl+D',function(){ 

									$('#014e0807-2843-4b79-9298-4894be88b6f3').focus().click();
									return false;
									});
			$('#45de40ad-7566-49af-9acf-2dcee08022ca').on('click', this.eventAgent(['FIConfig'], this, true));
						$(document).bind('keydown','Alt+Q',function(){ 

									$('#45de40ad-7566-49af-9acf-2dcee08022ca').focus().click();
									return false;
									});
			$('#13a6b90d-5bed-47c7-be08-53977cfe3fc1').on('click', this.eventAgent(['BatchConfig'], this, true));
						$(document).bind('keydown','Alt+W',function(){ 

									$('#13a6b90d-5bed-47c7-be08-53977cfe3fc1').focus().click();
									return false;
									});
			$('#5d5e8f22-2992-49e5-93df-c69fd1aa38af').on('click', this.eventAgent(['FICancelConfig'], this, true));
						$(document).bind('keydown','Alt+C',function(){ 

									$('#5d5e8f22-2992-49e5-93df-c69fd1aa38af').focus().click();
									return false;
									});
			$('#af0aa110-fa98-4233-b46f-9e4f962923af').on('click', this.eventAgent(['close'], this, true));
						$(document).bind('keydown','Alt+Ctrl+X',function(){ 

									$('#af0aa110-fa98-4233-b46f-9e4f962923af').focus().click();
									return false;
									});
$('#presetBar').buttongroup();
			...
			this.stateMachine.init();
				...
				onInitialized: function () {
						...
						this.context.setParam('formID', 'b8ad3e6b-13a4-4f25-a42a-3f61d1a6a575');
						var self = this,
							initAction=this.context.getParam('initAction'),
							actionFn = initAction ? this.context.action(initAction) : null;
						function refreshData(arg){
								return self.transitInvoke([{target:'GDWebReduceListController',methodName:'Formload',params:[arg]},]);
						}
						this.context.on('refreshData',function(event,arg){
								return refreshData(arg);
						});
